...
### 5. 🚀 Narrative UX: Launch Sequence & Aura Glow
...
### 7. 🌿 깃허브 잔디밭 커스텀 툴팁 (GitHub Contributions)
...
* **CSS 우선순위 제어 (`!important` 활용)**: 달력의 '오늘 날짜' 배경색과 공통 날짜의 `:hover` 반투명 효과가 겹쳐 가독성이 떨어지는 이슈를, 특정 클래스의 `:hover` 상태 우선순위를 높여 해결했습니다.
